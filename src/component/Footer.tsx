...
const Footer = () => {
  return (
    <>
      <hr className="h-px border-t-0 bg-transparent bg-linear-to-r from-transparent via-neutral-950 to-transparent opacity-25 dark:via-neutral-400" />
      <footer className="mt-auto">
        <div className="mx-auto w-full max-w-7xl p-4 py-6 lg:py-8">
          <div className="sm:flex sm:items-center sm:justify-between">
            <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">
              © Made by{' '}
              <a className="underline" href="https://github.com/ronald890119" target="_blank">
                ronald890119
              </a>
              <a href="https://github.com/ronald890119/mygo-searcher" target="_blank">
                <button className="ml-3 inline-flex items-center rounded border border-gray-400 bg-transparent px-2 py-1 font-semibold text-gray-400 hover:cursor-pointer hover:bg-gray-600">
            ...
            <div className="mt-4 flex sm:mt-0 sm:justify-center">
              <a
                href="https://www.linkedin.com/in/ronald890119/"
